...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(UseImplicitExplicitObjectCreationCodeFixProvider))]
    [Shared]
    public class UseImplicitExplicitObjectCreationCodeFixProvider : BaseCodeFixProvider
    {
        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { return ImmutableArray.Create(DiagnosticIdentifiers.UseImplicitExplicitObjectCreation); }
        }

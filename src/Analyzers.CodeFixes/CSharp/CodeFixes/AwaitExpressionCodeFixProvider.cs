...
namespace Roslynator.CSharp.CodeFixes
{
    ...
    public sealed class AwaitExpressionCodeFixProvider : BaseCodeFixProvider
    {
        ...
        {
            get { return ImmutableArray.Create(DiagnosticIdentifiers.AddOrRemoveConfigureAwaitCall); }
        }
        ...
        public override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            if (AddOrRemoveConfigureAwaitCallAnalyzer.IsConfigureAwait(awaitExpression.Expression))
            {

...
{
    public class RCS1090RemoveCallToConfigureAwaitTests : AbstractCSharpDiagnosticVerifier<AddOrRemoveConfigureAwaitCallAnalyzer, AwaitExpressionCodeFixProvider>
    {
        public override DiagnosticDescriptor Descriptor { get; } = DiagnosticRules.AddOrRemoveConfigureAwaitCall;

        public override CSharpTestOptions Options
        {
            get { return base.Options.AddConfigOption(ConfigOptionKeys.IncludeConfigureAwaitCall, false); }
        }

        [Fact, Trait(Traits.Analyzer, DiagnosticIdentifiers.AddOrRemoveConfigureAwaitCall)]

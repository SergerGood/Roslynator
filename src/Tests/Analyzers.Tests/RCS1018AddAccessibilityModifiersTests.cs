...
", options: Options.EnableConfigOption(ConfigOptionKeys.PreferExplicitAccessibilityModifiers));
        }
...
", options: Options.EnableConfigOption(ConfigOptionKeys.PreferExplicitAccessibilityModifiers).AddAllowedCompilerDiagnosticId(CompilerDiagnosticIdentifiers.CS0558_UserDefinedOperatorMustBeDeclaredStaticAndPublic));
        }

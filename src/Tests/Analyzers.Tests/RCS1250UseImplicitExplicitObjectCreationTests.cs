...
{
    public class RCS1250UseImplicitExplicitObjectCreationTests : AbstractCSharpDiagnosticVerifier<UseImplicitExplicitObjectCreationAnalyzer, UseImplicitExplicitObjectCreationCodeFixProvider>
    {
        public override DiagnosticDescriptor Descriptor { get; } = DiagnosticRules.UseImplicitExplicitObjectCreation;

...
{
    public class RCS1090AddCallToConfigureAwaitTests : AbstractCSharpDiagnosticVerifier<AddOrRemoveConfigureAwaitCallAnalyzer, AwaitExpressionCodeFixProvider>
    {
        public override DiagnosticDescriptor Descriptor { get; } = DiagnosticRules.AddOrRemoveConfigureAwaitCall;

        public override CSharpTestOptions Options
        {
            get { return base.Options.AddConfigOption(ConfigOptionKeys.IncludeConfigureAwaitCall, true); }
        }

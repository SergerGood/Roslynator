...
", options: Options.AddConfigOption(ConfigOptionKeys.PreferExplicitlyTypedArray, true));
        }
...
", options: Options.AddConfigOption(ConfigOptionKeys.PreferImplicitlyTypedArrayWhenTypeIsObvious, true));
        }
